...
export const AdminPanel = ({ user, users }) => {
    ...
    const theme = {
        colors: {
            ...
            hoverBg: 'rgba(255,255,255,0.1)' // Hover arka plan rengi
        }
    };
    ...
    return (
        <div style={{
            ...
            {/* Sidebar - Hover ile genişleyen yapı */}
            <aside
                style={{
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            {/* Profile menüsü için kullanıcı butonu */}
                            <div style={{ position: 'relative' }}>
                                ...
                                {/* Profil dropdown menüsü - Ayarlar seçeneği kaldırıldı */}
                                {showUserMenu && (
                                    <div style={{
                                        position: 'absolute',
                                        top: 'calc(100% + 0.5rem)',
